# RailsAdmin config file. Generated on May 28, 2013 15:04
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Jtbookstore', 'Admin']
  ...
  # config.excluded_models = ['Actor', 'Book', 'Image', 'Role', 'Store', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Actor', 'Book', 'Image', 'Role', 'Store', 'User']
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your actor.rb model definition
  ...
  #     configure :devote, :integer 
  #     configure :levels, :integer 
  ...
  #     configure :id, :integer 
  #     configure :bname, :string 
  #     configure :btype, :integer 
  #     configure :bdescript, :text 
  #     configure :bprice, :float 
  #     configure :bpublication, :date 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  ...
  #     configure :thumbnail_url, :string 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  #     configure :upload_updated_at, :datetime 
  ...
  #     configure :stype, :integer 
  #     configure :sdescript, :text 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  ...
  #     configure :actors, :has_many_association 
